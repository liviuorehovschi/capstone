...
def predict():
    ...
    print(f"[BEFORE] Memory: {mem_before:.2f} MB | CPU: {cpu_before:.2f}%")
    ...
    try:
        ...
        print(f"[AFTER] Memory: {mem_after:.2f} MB | CPU: {cpu_after:.2f}%")
...
def gradcam_image():
    process = psutil.Process(os.getpid())
    print(f"[GRADCAM] Before: {process.memory_info().rss / (1024 ** 2):.2f} MB")
    ...
    try:
        ...
        print(f"[GRADCAM] After: {process.memory_info().rss / (1024 ** 2):.2f} MB")
...
def saliency_image():
    process = psutil.Process(os.getpid())
    print(f"[SALIENCY] Before: {process.memory_info().rss / (1024 ** 2):.2f} MB")
    ...
    try:
        ...
        print(f"[SALIENCY] After: {process.memory_info().rss / (1024 ** 2):.2f} MB")
